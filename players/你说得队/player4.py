...
class Setting:
    ...
    def studentType() -> List[THUAI6.StudentType]:
        return [THUAI6.StudentType.StraightAStudent, THUAI6.StudentType.StraightAStudent, THUAI6.StudentType.StraightAStudent, THUAI6.StudentType.Teacher]
...
class AI(IAI):
    ...
    def updatestuposition(self,api:IStudentAPI)->None:
        ...
        if len(self.trickerPosition)==2:
            self.stuposition[4]=(self.trickerPosition[0],self.trickerPosition[1])
    ...
    def StuPlay(self, api:IStudentAPI):
        ...
        if self.state==1:#处于修机模式
                if api.GetSelfInfo().studentType.name=='Teacher':#如果自己是教师 优先救人
