...
template<> ::protobuf::MessageOfButcher* Arena::CreateMaybeMessage<::protobuf::MessageOfButcher>(Arena*);
template<> ::protobuf::MessageOfHuman* Arena::CreateMaybeMessage<::protobuf::MessageOfHuman>(Arena*);
...
class MessageOfHuman final :
 ...
 public:
  inline MessageOfHuman() : MessageOfHuman(nullptr) {}
  ...
  protected:
  explicit MessageOfHuman(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
class MessageOfButcher final :
 ...
 public:
  inline MessageOfButcher() : MessageOfButcher(nullptr) {}
  ...
  protected:
  explicit MessageOfButcher(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
inline const ::protobuf::MessageOfMap& MessageToClient::_internal_map_massage() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::protobuf::MessageOfMap&>(
      ::protobuf::_MessageOfMap_default_instance_);
}
